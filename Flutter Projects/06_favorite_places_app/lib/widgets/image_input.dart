...
class _ImageInput extends State<ImageInput> {
  ...
  // This is used to take pictures the image picked returns a future
  void _takePicture() async {
    final imagePicker = ImagePicker();
    final pickedImage = await imagePicker.pickImage(source: ImageSource.camera, maxWidth: 600,);

    // No image was selecterd
    if (pickedImage == null) {
      return;
    }

    // This is the way to change the return value to an actual File as we can use it
    setState(() {
