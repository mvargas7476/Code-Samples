...
class _NewExpenseState extends State<NewExpense> {
  ...
  void _showDialog() {
    // Here we just check which Alert Dialog we want to show
    if(Platform.isIOS) {
  ...
  Widget build(BuildContext context) {
    // This is use to check if the keyboard is going to block too much of the app
    final keyboardSpace = MediaQuery.of(context).viewInsets.bottom;

    // Here I am just trying to learn about LayoutBuilder. Which  is the reason for the code duplication
    return LayoutBuilder(
      builder: (ctx, constraints) {
        // This is just a variable easier to use to learn about LayoutBuilder
